...
<style>
#header h1 {background: url(/s_images/nudibranch_1-sm.jpg) no-repeat;}
</style>
</head>
<body>
...
<table class="cutepic right" cellspacing='0' cellpadding='0'>
  <tr><td class="cutepic"><img class="cutepic"
       src="/images/Stenorhynchus_seticornis_YellowLineArrowCrab-sm.jpeg"
       alt="Stenorhynchus seticornis" /></td></tr>
  <tr><td class="cutepic"><i>Stenorhynchus seticornis</i></td></tr>
</table>
<p class='hr'>SCAMIT is pleased to post relevant job opportunities.
Please send listings to:</p>
<dl>
<dt>Larry Lovell</dt>
<dd>Marine Biology Lab, County Sanitation Districts of Los Angeles County
24501 S. Figueroa St., Carson, CA 90745
<br>310.830.2400 x5613
<i>email:</i> <a href="mailto:LLovell@lacsd.org">LLovell@lacsd.org</a>
</dd>
</dl>
...
<div class='job'><p
  ...
  records. Develop and maintain computer databases of
  holdings. Process approved loan requests. Supervise and train
  visitors, students, volunteers and limited employees. Advise
  researchers and graduate students on the best techniques and
  selection of material. Prepare exhibits and make presentations to
  the public. Assist with grant proposal preparation and special
  projects. Sort, identify and carry out morphometric analysis of
  zooplankton. Coordinate cruise preparations. Expand and improve
  systematic sortings and prepare digital catalogs and other summaries
  of holdings. Make recommendations to Curator for expanding
...
<div class='job'><p
  ...
  advocacy.<br />
  <b>Position Summary:</b><br /> The Staff Scientist is responsible
  for marine and coastal resources related technical and policy
  projects for the organization. This consists of providing written
  comments and testimony on various issues including the impacts of
  power plants and desalination on marine resources; establishment of
  marine protected areas; local coastal planning; coastal aquatic
  resource protection including wetlands and riparian habitat; and
  coastal industrial uses. The Staff Scientist will also help forward
  ongoing coastal resources projects, such as the implementation of
  marine protected areas, and advance policy recommendations before
  various local and state agencies. The Staff Scientist will also
  represent Heal the Bay at public and stakeholder group
  meetings. This position requires a strong technical background, and
  experience in the policy arena is preferred. Candidates must be
  motivated, articulate and strong problem solvers. This is a full
  time salaried position with health, dental, vision and vacation
  ...
  promote diversity in our workforce.<br />
