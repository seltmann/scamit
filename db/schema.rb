...
ActiveRecord::Schema.define(:version => 20100724122340) do
  ...
  create_table "morphbanks", :force => true do |t|
  ...
  create_table "uploads", :force => true do |t|
    ...
    t.datetime "created_at"
    t.datetime "updated_at"
    t.string   "uploadtype",          :default => "morphbank", :null => false
  end
