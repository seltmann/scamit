...
function php_file_tree_dir($directory, $return_link,
                           $extensions = array(), $first_call = true) {
      ...
      if( $this_file != "." && $this_file != ".." ) {
        if( is_dir("$directory/$this_file") ) {
          ...
          $php_file_tree .= "<li class=\"pft-directory\"><a href=\"#\">" .
                            htmlspecialchars($this_file) . "</a>";
          $php_file_tree .= php_file_tree_dir("$directory/$this_file",
                                              $return_link ,$extensions, false);
          $php_file_tree .= "</li>\n";
        } else {
          // File
          // Get extension (prepend 'ext-' to prevent invalid classes from
